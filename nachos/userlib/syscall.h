...
#define SC_YIELD	 11
#define SC_PERROR        12
#define SC_P             13 //TODODO: start //TODODO: aller dans exception.cc et chaque case -> une exception à gerer, voir pour SC_PERROR
#define SC_V             14
...
#define SC_COND_BROADCAST 25 //TODODO: end
